...
-- ----------------------------
INSERT INTO `course_module` VALUES ('实验', 'XX110110s');
INSERT INTO `course_module` VALUES ('平时', 'XX110110');
INSERT INTO `course_module` VALUES ('平时', 'XX110240');
INSERT INTO `course_module` VALUES ('期末', 'XX110110');
INSERT INTO `course_module` VALUES ('期末', 'XX110240');
...
CREATE TABLE `item`  (
  ...
  `item_value` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评分项分值',
  `cid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT ' 一门课一种计算方法',
  `part` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '对应期末模块的?部分',
...
CREATE TABLE `study_goal`  (
  ...
  `graduate_require` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '支撑毕业指标点',
  `eva_point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '观测点',
  ...
  `description` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '课程目标成绩分布描述',
  `analysis` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '课程目标成绩分布分析',
...
-- ----------------------------
INSERT INTO `study_goal` VALUES (0, 'XX110110', '2.4', '考勤,卷面：[大题一,大题二,大题三]', 35.00, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (0, 'XX110110s', '8.3', '程序和报告：[程序P1+P2,报告R1+R2]', 25.00, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (0, 'XX110240', '1.1', '考勤,卷面考试：[大题一]', 21.80, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (1, 'XX110110', '3.3', '课堂表现,作业1', 20.00, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (1, 'XX110110s', '4.2', '程序和报告：[程序P3+ P4,报告R3+R4,测试题]', 50.00, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (1, 'XX110240', '2.1', '卷面考试：[大题二]', 11.20, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (2, 'XX110110', '4.2', '卷面：[大题四]', 22.40, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (2, 'XX110110s', '5.2', '程序和报告：[程序P5+ P6,报告R5+R6]', 25.00, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (2, 'XX110240', '2.2', '课堂表现,1-4章作业,卷面考试：[大题三]', 40.20, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (3, 'XX110110', '5.3', '卷面：[大题五],作业2', 22.60, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `study_goal` VALUES (3, 'XX110240', '2.4', '5-7章作业,卷面考试：[大题四]', 26.80, NULL, NULL, NULL, NULL, NULL);
