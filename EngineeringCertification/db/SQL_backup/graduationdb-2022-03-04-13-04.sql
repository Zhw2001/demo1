...
CREATE TABLE `admin_authority`  (
  ...
  `authority_name` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '权限名字',
  `authority_type` int NULL DEFAULT NULL COMMENT '权限类型',
  `authority_parent_id` bigint NULL DEFAULT NULL COMMENT '权限父ID',
  `authority_parent_name` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '父权限名字',
  `authority_url` char(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '权限树的连接路径',
  `authority_sort` int NULL DEFAULT -1 COMMENT '权限树的排序',
  `authority_description` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '权限描述',
  `auth_enable` int NULL DEFAULT 0 COMMENT '是否可以显示',
  `auth_create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
-- ----------------------------
INSERT INTO `admin_authority` VALUES (1, '内容合理性审核', 1, NULL, '', 'EA', 1, '', 1, '2022-01-06 15:09:48');
INSERT INTO `admin_authority` VALUES (2, '考核信息填写', 1, 1, '内容合理性审核', 'EA_Input', 1, '填写内容合理性审核所需信息', 1, '2022-01-24 14:03:37');
INSERT INTO `admin_authority` VALUES (3, '课程目标成绩明细', 1, NULL, '', 'CGD', 2, '', 1, '2022-01-24 13:59:36');
INSERT INTO `admin_authority` VALUES (4, '课程成绩录入', 1, 3, '课程目标成绩明细', 'CGD_Input', 1, '录入课程成绩数据', 1, '2022-02-13 16:21:56');
INSERT INTO `admin_authority` VALUES (5, '课程目标达成度评价', 1, NULL, '', 'ADE', 3, '', 1, '2022-02-13 16:21:59');
INSERT INTO `admin_authority` VALUES (6, '目标信息填写', 1, 5, '课程目标达成度评价', 'ADE_Input', 1, '目标达成度评价所需信息填写', 1, '2022-02-13 16:24:11');
INSERT INTO `admin_authority` VALUES (7, '我的历史课程信息', 1, NULL, '', 'MyCourse', 4, '', 1, '2022-02-13 16:24:49');
INSERT INTO `admin_authority` VALUES (8, '课程列表', 1, 7, '我的历史课程信息', 'Latest_C_Info', 1, '所负责课程信息的展示', 1, '2022-02-17 22:15:12');
INSERT INTO `admin_authority` VALUES (9, '课程目标明细', 1, 7, '我的历史课程信息', 'Latest_A_Detail', 2, '历史生成的课程目标明细下载', 1, '2022-02-17 22:15:16');
INSERT INTO `admin_authority` VALUES (10, '用户管理', 1, NULL, NULL, 'User', 5, NULL, 1, '2022-02-17 22:15:18');
INSERT INTO `admin_authority` VALUES (11, '用户信息', 1, 10, '用户管理', 'UserInfo', 1, '读取和写入用户信息', 1, '2022-02-17 22:15:20');
INSERT INTO `admin_authority` VALUES (12, '用户角色', 1, 10, '用户管理', 'UserRole', 2, '设置用户角色', 1, '2022-02-17 22:15:23');
INSERT INTO `admin_authority` VALUES (13, '用户权限', 1, 10, '用户管理', 'UserAuth', 3, '查看用户权限', 1, '2022-02-17 22:15:25');
INSERT INTO `admin_authority` VALUES (14, '分配课程', 1, 10, '用户管理', 'UserCourse', 4, '为老师分配教授的课程', 1, '2022-02-26 14:39:34');
...
CREATE TABLE `admin_role`  (
  `role_id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id 主键，自增',
  `role_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '账户',
  `role_description` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '角色描述',
  `role_create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `admin_role_auth`  (
  `RA_role_id` bigint NOT NULL,
  `RA_authority_id` bigint NOT NULL,
...
INSERT INTO `admin_role_auth` VALUES (2, 6);
...
CREATE TABLE `admin_user`  (
  `uid` bigint NOT NULL AUTO_INCREMENT COMMENT 'uid',
  `account` char(80) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '账户',
  `truename` varchar(16) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '昵称',
  ...
  `description` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '账户描述',
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `rank` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '负责教授的所有课程编号',
...
-- ----------------------------
INSERT INTO `admin_user` VALUES (1, 'admin', 'zzz', '123456', 15821713348, 'admin@my.com', NULL, '2022-01-30 14:46:42', '1');
INSERT INTO `admin_user` VALUES (2, 'user01', '章夏芬', '123456', 13564911632, 'xfzhang@shmtu.edu.cn', NULL, '2022-01-19 16:01:22', '1');
INSERT INTO `admin_user` VALUES (3, 'user02', '毕坤', '123456', 13601880532, 'kbi@shmtu.edu.cn', NULL, '2022-01-19 16:02:04', '1');
INSERT INTO `admin_user` VALUES (4, 'user03', '张琳', '123456', 18901630605, 'lzhang@shmtu.edu.cn', NULL, '2022-01-19 16:01:54', '1');
INSERT INTO `admin_user` VALUES (5, 'user04', '陈磊', '123456', 13764446515, 'lchen@shmtu.edu.cn', NULL, '2022-01-19 16:01:52', '1');
INSERT INTO `admin_user` VALUES (6, 'user05', '孙伟', '123456', 15801911620, 'wsun@shmtu.edu.cn', NULL, '2022-01-19 16:02:01', '1');
INSERT INTO `admin_user` VALUES (7, 'user06', '徐明', '123456', 13564775928, 'mxu@shmtu.edu.cn', NULL, '2022-01-19 16:01:49', '1');
INSERT INTO `admin_user` VALUES (8, 'user07', '刘玉欣', '123456', 15618031883, 'yxliu@shmtu.edu.cn', NULL, '2022-01-19 16:01:31', '1');
INSERT INTO `admin_user` VALUES (9, 'user08', '黄晓霞', '123456', 18916125849, 'xxhuang@shmtu.edu.cn', NULL, '2022-01-19 16:01:27', '1');
INSERT INTO `admin_user` VALUES (10, 'user09', '朱春鹤', '123456', 13311857121, 'chzhu@shmtu.edu.cn', NULL, '2022-01-19 16:01:57', '1');
INSERT INTO `admin_user` VALUES (11, 'user10', '焦佳佳', '123456', 18930033406, 'jjjiao@shmtu.edu.cn', NULL, '2022-01-18 14:49:40', '1');
INSERT INTO `admin_user` VALUES (12, 'user11', '杨智应', '123456', 13524844206, 'zyyang@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (13, 'user12', '于楠', '123456', 13917206959, 'nyu@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (14, 'user13', '韩玉娟', '123456', 13004121816, 'yjhan@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (15, 'user14', '栾翠菊', '123456', 13795274661, 'cjluan@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (16, 'user15', '石玉虎', '123456', 18221235653, 'yhshi@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (17, 'user16', '吴昊', '123456', 13524070671, 'hwu@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (18, 'user17', '金世双', '123456', 18918855581, 'ssjin@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (19, 'user18', '徐琪', '123456', 13661598030, 'qxu@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (20, 'user19', '宋淼', '123456', 18816671812, 'msong@shmtu.edu.cn', NULL, NULL, '1');
INSERT INTO `admin_user` VALUES (21, 'user20', '刘晋', '123456', 13918096752, 'jliu@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (22, 'user21', '朱昌明', '123456', 13472413658, 'cmzhu@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (23, 'user22', '李启明', '123456', 13585737560, 'qmli@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (24, 'user23', '刘广钟', '123456', 13816916261, 'gzliu@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (25, 'user24', '姜胜明', '123456', 13052306769, 'smjiang@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (26, 'user25', '姚敏', '123456', 18301886392, 'myao@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (27, 'user26', '刘天宇', '123456', 15829366416, 'tyliu@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (28, 'user27', '白治江', '123456', 13817265822, 'zjbai@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (29, 'user28', '葛元', '123456', 13386060316, 'yge@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (30, 'user29', '周日贵', '123456', 13564113020, 'rgzhou@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (31, 'user30', '王卫华', '123456', 13764930311, 'whwang@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (32, 'user31', '王晓峰', '123456', 13166321968, 'xfwang@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (33, 'user32', '高茂庭', '123456', 13816708560, 'mtgao@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (34, 'user33', '张翼飞', '123456', 18917230618, 'yfzhang@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (35, 'user34', '魏莱', '123456', 13524662750, 'lwei@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (36, 'user35', '刘昱昊', '123456', 13681959650, 'yhliu@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (37, 'user36', '刘静', '123456', 17316388512, 'jliu@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (38, 'user37', '宋安军', '123456', 13764446600, 'ajsong@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (39, 'user38', '李美晶', '123456', 18616334003, 'mjli@shmtu.edu.cn', '', '2022-02-07 19:47:19', '2');
INSERT INTO `admin_user` VALUES (40, 'user39', '谭佛晓', '123456', 15556558295, 'fxtan@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (41, 'user40', '史小宏', '123456', 13381712752, 'xhshi@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (42, 'user41', '胡西川', '123456', 13918349790, 'xchu@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (43, 'user42', '曾卫明', '123456', 13681877268, 'wmzeng@shmtu.edu.cn', NULL, NULL, '2');
INSERT INTO `admin_user` VALUES (44, 'user43', '周凡', '123456', 13671892160, 'fzhou@shmtu.edu.cn', NULL, NULL, '2');
...
-- ----------------------------
-- Table structure for admin_user_course
-- ----------------------------
DROP TABLE IF EXISTS `admin_user_course`;
CREATE TABLE `admin_user_course`  (
  `uid` bigint NOT NULL,
  `cid` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`uid`, `cid`) USING BTREE,
  INDEX `foreign_cid`(`cid` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of admin_user_course
-- ----------------------------
INSERT INTO `admin_user_course` VALUES (1, '00100061');
INSERT INTO `admin_user_course` VALUES (1, '00330011');
INSERT INTO `admin_user_course` VALUES (1, 'WL210011');
INSERT INTO `admin_user_course` VALUES (1, 'WL210012');
INSERT INTO `admin_user_course` VALUES (1, 'XX110110');
INSERT INTO `admin_user_course` VALUES (2, 'XX110110');
INSERT INTO `admin_user_course` VALUES (3, 'XX110110');
...
CREATE TABLE `admin_user_role`  (
  `UR_uid` bigint NOT NULL,
  `UR_role_id` bigint NOT NULL,
  PRIMARY KEY (`UR_uid`, `UR_role_id`) USING BTREE,
  INDEX `role`(`UR_role_id` ASC) USING BTREE,
  CONSTRAINT `role` FOREIGN KEY (`UR_role_id`) REFERENCES `admin_role` (`role_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user` FOREIGN KEY (`UR_uid`) REFERENCES `admin_user` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `audit_info`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '课程审核信息ID',
  `semester` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评价与审核该课程的学期',
  `cid` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课程编号',
  `classes` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `exam_type` int NULL DEFAULT NULL COMMENT '0-考试/1-考查',
  `course_property` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `exam_date` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `course_point` float(20, 0) NULL DEFAULT NULL COMMENT '学分',
  `week_hour` float(20, 0) NULL DEFAULT NULL COMMENT '周学时',
  `course_hour` float(20, 0) NULL DEFAULT NULL COMMENT '总学时',
  `lesson_hour` float(20, 0) NULL DEFAULT NULL,
  `practice_hour` float(20, 0) NULL DEFAULT NULL,
  `textbook` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '教材信息',
  `goals_degree_describe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '该课程所有目标的总分析',
...
-- ----------------------------
INSERT INTO `audit_info` VALUES (1, '2023-2024-2', 'XX110110', '计算机192', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `cdesign`  (
  ...
  `select` double(20, 2) NULL DEFAULT NULL,
  `begin` double(20, 2) NULL DEFAULT NULL,
  `medium` double(20, 2) NULL DEFAULT NULL,
  `program` double(20, 2) NULL DEFAULT NULL,
  `answer` double(20, 2) NULL DEFAULT NULL,
  `report` double(20, 2) NULL DEFAULT NULL,
  `overall` double(20, 2) NULL DEFAULT NULL,
  `cdesign_id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `course`  (
  ...
  `sState` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `regular` double(20, 2) NULL DEFAULT NULL COMMENT '平时成绩',
  `written` double(20, 2) NULL DEFAULT NULL COMMENT '考试成绩',
  `overall` double(20, 2) NULL DEFAULT NULL COMMENT '总成绩',
  `degree` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '总课程目标达成度',
  `s0` float NULL DEFAULT NULL COMMENT '平时考核标准成绩1',
  `s1` float NULL DEFAULT NULL COMMENT '平时考核标准成绩2',
  `s2` float NULL DEFAULT NULL,
  `s3` float NULL DEFAULT NULL,
  `s4` float NULL DEFAULT NULL,
  `s5` float NULL DEFAULT NULL,
  `s6` float NULL DEFAULT NULL,
  `s7` float NULL DEFAULT NULL,
  `s8` float NULL DEFAULT NULL,
  `s9` float NULL DEFAULT NULL,
  `s10` float NULL DEFAULT NULL,
  `s11` float NULL DEFAULT NULL,
  `s12` float NULL DEFAULT NULL,
  `s13` float NULL DEFAULT NULL,
  `s14` float NULL DEFAULT NULL,
  `s15` float NULL DEFAULT NULL,
  `q0` float NULL DEFAULT NULL COMMENT '期末考试大题成绩1',
  `q1` float NULL DEFAULT NULL COMMENT '期末考试大题成绩2',
  `q2` float NULL DEFAULT NULL,
  `q3` float NULL DEFAULT NULL,
  `q4` float NULL DEFAULT NULL,
  `q5` float NULL DEFAULT NULL,
  `q6` float NULL DEFAULT NULL,
  `q7` float NULL DEFAULT NULL,
  `q8` float NULL DEFAULT NULL,
  `q9` float NULL DEFAULT NULL,
  `q10` float NULL DEFAULT NULL,
  `q11` float NULL DEFAULT NULL,
  `q12` float NULL DEFAULT NULL,
  `q13` float NULL DEFAULT NULL,
  `q14` float NULL DEFAULT NULL,
  `q15` float NULL DEFAULT NULL,
  `g0` float NULL DEFAULT NULL COMMENT '课程目标达成度1',
  `g1` float NULL DEFAULT NULL COMMENT '课程目标达成度2',
  `g2` float NULL DEFAULT NULL,
  `g3` float NULL DEFAULT NULL,
  `g4` float NULL DEFAULT NULL,
  `g5` float NULL DEFAULT NULL,
  `g6` float NULL DEFAULT NULL,
  `g7` float NULL DEFAULT NULL,
  `g8` float NULL DEFAULT NULL,
  `g9` float NULL DEFAULT NULL,
  `g10` float NULL DEFAULT NULL,
  `g11` float NULL DEFAULT NULL,
  `g12` float NULL DEFAULT NULL,
  `g13` float NULL DEFAULT NULL,
  `g14` float NULL DEFAULT NULL,
  `g15` float NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for course_goal
-- ----------------------------
DROP TABLE IF EXISTS `course_goal`;
CREATE TABLE `course_goal`  (
  `course_goal_id` int NOT NULL COMMENT '课程目标号',
  `audit_id` bigint NOT NULL COMMENT '课程审核信息id',
  `course_goal_text` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课程目标内容',
  `excellent` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `good` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `normal` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `pass` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `poor` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `graduate_require` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '支撑毕业指标点',
  `eva_point` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '观测点',
  `total_score` float(20, 2) NULL DEFAULT NULL COMMENT '总分',
  `expectation` float(20, 2) NULL DEFAULT NULL COMMENT '期望值(均分)',
  `not_reach` int NULL DEFAULT NULL COMMENT '未达成人数',
  `achieve_degree` float(20, 2) NULL DEFAULT NULL COMMENT '达成度',
  `score_description` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课程目标成绩分布描述',
  `score_analysis` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '课程目标成绩分布分析',
  PRIMARY KEY (`course_goal_id`, `audit_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of course_goal
-- ----------------------------
INSERT INTO `course_goal` VALUES (0, 1, ' 能运用操作系统的原理描述进程和线程，能分析影响处理调度、磁盘调度、存储器管理、文件管理和输入输出系统的因素，会对比不同解决方案的优缺点，给出结论。 ', '能准确运用操作系统的原理描述进程和线程，能准备分析影响处理调度、磁盘调度、存储器管理、文件管理和输入输出系统的因素，能准确对比不同解决方案的优缺点。', '能合理运用操作系统的原理描述进程和线程，能分析影响处理调度、磁盘调度、存储器管理、文件管理和输入输出系统的因素，会对比不同解决方案的优缺点。', '能合理运用操作系统的原理描述进程和线程，能分析影响处理调度、磁盘调度、存储器管理、文件管理和输ppppppp', '能运用操作系统的原理描述进程和线程，基本能分析影响处理调度、磁盘调度、存储器管理、文件管理和输入输出系统的因素，基本上会对比不同解决方案的优缺点。', '不能分析影响处理调度、磁盘调度、存储器管理、文件管理和输入输出系统的因素，不能对比不同解决方案的优缺点。', '2.4', '考勤,卷面：[大题一,大题二,大题三]', 35.00, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_goal` VALUES (1, 1, '在具体场景和任务有变化时，能针对新的用户目标和需求，设计新的处理机调度方案、存储器访问方案、文件分配方案或设备管理方案，并能分析解决方案在时间上或空间上的开销。', '针对新的用户目标和需求，能系统设计新的处理机调度方案、存储器访问方案、文件分配方案或设备管理方案，能合理分析解决方案在时间上或空间上的开销', '针对新的用户目标和需求，能设计合理的处理机调度方案、存储器访问方案、文件分配方案或设备管理方案，能分析解决方案在时间上或空间上的开销', '针对新的用户目标和需求，基本能设计新的处理机调度方案、存储器访问方案、文件分配方案或设备管理方案，111111111111', '针对新的用户目标和需求，基本能设计新的处理机调度方案、存储器访问方案、文件分配方案或设备管理方案，基本能分析解决方案在时间上或空间上的开销', '不能针对新的用户目标和需求设计新的处理机调度方案、存储器访问方案、文件分配方案或设备管理方案，不能分析解决方案在时间上或空间上的开销', '3.3', '课堂表现,作业1', 20.00, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_goal` VALUES (2, 1, '能分析程序的并发性程度，用前趋图描述程序的并发执行，构建并发系统，能测算不同的调度机制、信号量和同步机制、存储方式和置换算法下的时间和空间的成本。', '能准确分析程序的并发性程度，会用前趋图描述程序的并发执行，构建完善的并发系统，能准备测算不同的调度机制、信号量和同步机制、存储方式和置换算法下的时间和空间的成本', '能合理分析程序的并发性程度，会用前趋图描述程序的并发执行，构建并发系统，能测算不同的调度机制、信号量和同步机制、存储方式和置换算法下的时间和空间的成本', '能合理分析程序的并发性程度，会用前趋图描述程序的并发执行，构建并发系统，能测算不同的调度机制、信号量和同步机制、存储方式和置换算法11111111111111111', '基本能分析程序的并发性程度，基本会用前趋图描述程序的并发执行，能构建并发系统，基本能测算不同的调度机制、信号量和同步机制、存储方式和置换算法下的时间和空间的成本', '无法分析程序的并发性程度，不会用前趋图描述程序的并发执行，不能能测算不同的调度机制、信号量和同步机制、存储方式和置换算法下的时间和空间的成本', '4.2', '卷面：[大题四]', 22.40, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `course_goal` VALUES (3, 1, '能就具体场景，模拟生产者消费者、磁盘调度、文件管理统或存储器管理的操作流程，设计系统，并能分析、对比不同操作方案的成本和局限性。', '就具体场景，能准确模拟生产者消费者、磁盘调度、文件管理统或存储器管理的操作流程，设计系统，能准备分析、对比不同操作方案的成本和局限性', '就具体场景，能合理模拟生产者消费者、磁盘调度、文件管理统或存储器管理的操作流程，设计系统，能合理分析、对比不同操作方案的时间和空间成本', '就具体场景，能合理模拟生产者消费者、磁盘调度、文件管理统或存储器管理的操作流程，设计系统，能合理分析、对比不同操作1111111111', '就具体场景，基本能模拟生产者消费者、磁盘调度、文件管理统或存储器管理的操作流程，设计系统，能基本分析、对比不同操作方案的成本和局限性', '能就具体场景，模拟生产者消费者、磁盘调度、文件管理统或存储器管理的操作流程，设计系统，并能分析、对比不同操作方案的成本和局限性', '5.3', '卷面：[大题五],作业2', 22.60, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `course_item`  (
  ...
  `part_id` bigint NOT NULL COMMENT '单元识别号',
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卷面评分项',
  `score` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评分项分值',
  `index` int NULL DEFAULT NULL COMMENT 'item序号',
  PRIMARY KEY (`item_id`) USING BTREE,
  UNIQUE INDEX `unique_part_id_name`(`part_id` ASC, `name` ASC) USING BTREE,
  CONSTRAINT `fk_part_id` FOREIGN KEY (`part_id`) REFERENCES `course_part` (`part_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of course_item
-- ----------------------------
INSERT INTO `course_item` VALUES (1, 36, '大题一', '10', 0);
INSERT INTO `course_item` VALUES (2, 36, '大题二', '15', 1);
INSERT INTO `course_item` VALUES (3, 36, '大题三', '15', 2);
INSERT INTO `course_item` VALUES (4, 36, '大题四', '32', 3);
INSERT INTO `course_item` VALUES (5, 36, '大题五', '28', 4);
INSERT INTO `course_item` VALUES (6, 33, '作业1-6', '100', 0);
INSERT INTO `course_item` VALUES (7, 34, '作业7-8', '100', 0);
INSERT INTO `course_item` VALUES (8, 32, '考勤', '100', 0);
INSERT INTO `course_item` VALUES (9, 35, '课堂', '100', 0);
...
CREATE TABLE `course_module`  (
  `module_id` bigint NOT NULL AUTO_INCREMENT COMMENT '模块识别号',
  `audit_id` bigint NOT NULL,
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `index` int NULL DEFAULT NULL COMMENT '模块顺序',
  PRIMARY KEY (`module_id`) USING BTREE,
  UNIQUE INDEX `unique_module_id`(`module_id` ASC) USING BTREE COMMENT 'module_id虽不是主键但作为识别号依旧需要唯一'
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of course_module
-- ----------------------------
INSERT INTO `course_module` VALUES (15, 1, '平时', 0);
INSERT INTO `course_module` VALUES (16, 1, '期末', 1);

-- ----------------------------
-- Table structure for course_part
-- ----------------------------
DROP TABLE IF EXISTS `course_part`;
CREATE TABLE `course_part`  (
  `part_id` bigint NOT NULL AUTO_INCREMENT COMMENT '单元识别号',
  `module_id` bigint NOT NULL COMMENT '模块识别号,外键',
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '平时成绩模块组成部分',
  `ratio` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '比例',
  `index` int NULL DEFAULT NULL COMMENT '组成部分序号',
  PRIMARY KEY (`part_id`) USING BTREE,
  UNIQUE INDEX `unique_module_id_name`(`module_id` ASC, `name` ASC) USING BTREE,
  CONSTRAINT `fk_module_id` FOREIGN KEY (`module_id`) REFERENCES `course_module` (`module_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of course_part
-- ----------------------------
INSERT INTO `course_part` VALUES (32, 15, '考勤', '7', 0);
INSERT INTO `course_part` VALUES (33, 15, '作业1-6', '12', 1);
INSERT INTO `course_part` VALUES (34, 15, '作业7-8', '3', 2);
INSERT INTO `course_part` VALUES (35, 15, '课堂', '8', 3);
INSERT INTO `course_part` VALUES (36, 16, '卷面', '70', 0);
...
CREATE TABLE `courseinfo`  (
  ...
  `cTarget` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `excellent` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '优秀（>=90)',
  `good` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '良好(<90,>80)',
  `normal` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '中等(<80,>70)',
  `pass` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '及格(<70,>60)',
  `poor` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '不及格(<60)',
  `course_type` int NULL DEFAULT 0 COMMENT '课程的类型：0-理论课，1-实验课，2-课程设计，3-毕业设计',
  `test_type` int NULL DEFAULT NULL COMMENT '考核类型：0-考试，1-考察',
  `standard_num` int NULL DEFAULT NULL COMMENT '考核标准数量',
  `standard_names` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '考核标准名称明细，JSON一维String数组',
  `question_num` int NULL DEFAULT NULL COMMENT '考试大题数量',
  `question_names` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '考试大题名称明细，JSON一维String数组',
  `goal_num` int NULL DEFAULT NULL COMMENT '教学目标数量',
  `score_distribution` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分数分布，JSON二维float数组，size=goal_num*(standard_num+question_num)',
  PRIMARY KEY (`info_cNum`) USING BTREE,
  INDEX `info_cId`(`info_cId` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of courseinfo
-- ----------------------------
INSERT INTO `courseinfo` VALUES (1, '数学系', NULL, 'WL310011', '大学物理(一)', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (2, '数学系', NULL, 'WL310012', '大学物理(二)', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (3, '数学系', NULL, 'WL320020', '物理实验', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (4, '数学系', NULL, 'WL210011', '高等数学A（一）', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (5, '数学系', NULL, 'WL210012', '高等数学A（二）', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (6, '数学系', NULL, 'WL210140', '概率论与数理统计', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (7, '数学系', NULL, 'WL210040', '线性代数', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (8, '行政系', NULL, 'WL410010', '中国近现代史纲要', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (9, '行政系', NULL, 'WL410040', '马克思主义原理', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (10, '行政系', NULL, 'WL420020', '思想道德与法律基础', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (11, '体育部', NULL, 'WL510011', '体育（一）', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (12, '体育部', NULL, 'WL510012', '体育（二）', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (13, '体育部', NULL, 'WL510013', '体育（三）', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (14, '体育部', NULL, 'WL510014', '体育（四）', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (15, '学生处', NULL, 'QT620010', '军事理论', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (16, '学生处', NULL, 'QT620020', '形势与政策', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (17, '教务处', NULL, 'QT820010', '第二课堂', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (18, '计算机系', NULL, 'XX110270', '离散数学', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (19, '计算机系', NULL, 'XX110590', '高级语言程序设计', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (20, '计算机系', NULL, 'XX110170s', '高级语言程序设计实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (21, '计算机系', NULL, 'XX110280', '面向对象程序设计', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (22, '计算机系', NULL, 'XX127270', '面向对象程序设计课程设计', '', NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (23, '计算机系', NULL, 'XX110120', '电路与电子学', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (24, '计算机系', NULL, 'XX110120s', '电路与电子学实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (25, '计算机系', NULL, 'XX110420', '数字逻辑', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (26, '计算机系', NULL, 'XX110420s', '数字逻辑实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (27, '计算机系', NULL, 'XX110380', '数据结构', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (28, '计算机系', NULL, 'XX110380s', '数据结构实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (29, '计算机系', NULL, 'XX110110', '操作系统', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 3, '[\"考勤\", \"课堂表现\", \"作业\"]', 4, '[\"第1大题\", \"第2大题\", \"第3大题\", \"第4大题\"]', 4, '[[7, 0, 0, 70, 70, 0, 0], [0, 8, 12, 0, 0, 0, 0], [0, 0, 0, 0, 0, 70, 0], [0, 0, 3, 0, 0, 0, 70]]');
INSERT INTO `courseinfo` VALUES (30, '计算机系', NULL, 'XX110110s', '操作系统实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (31, '计算机系', NULL, 'XX127030', '操作系统课程设计', '', NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (32, '计算机系', NULL, 'XX110210', '计算机网络', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (33, '计算机系', NULL, 'XX110210s', '计算机网络实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (34, '计算机系', NULL, 'XX110240', '计算机原理与汇编', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (35, '计算机系', NULL, 'XX110240s', '计算机原理与汇编实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (36, '计算机系', NULL, 'XX110390', '数据库原理及应用', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (37, '计算机系', NULL, 'XX110390s', '数据库原理及应用实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (38, '计算机系', NULL, 'XX127090', '数据库原理及应用课程设计', '', NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (39, '计算机系', NULL, 'XX110480', '微型计算机技术', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (40, '计算机系', NULL, 'XX110480s', '微型计算机技术实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (41, '计算机系', NULL, 'XX110100', '编译原理', '课程目标1：能阐述和解释文法与语言、正规文法、正规表达式、自动机、上下文无关文法，LL(1)文法、LR(0)、 SLR(1)、LR(1)、LALR(1)、语法制导的语义计算、属性文法中的关键概念，能列举出这些关键概念的典型例子, 并能判断关于这些关键概念的基本命题的正确性。（支撑毕业要求1.1中“掌握表述计算机工程问题所需的数学、自然科学和工程基础理论”）；\n课程目标2：能描述词法分析所需的正规表达式的构造规则，并能设计基本词法规则的正规式。能使用自动机的相互转换方法将不同类型的自动机转换为对应的等价形式', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (42, '计算机系', NULL, 'XX120180', '计算方法', '课程目标1：标点1.2：掌握计算机程序设计所需的数学表达方式、计算方法、数据结构。课程目标2：指标点4.3：能够分析系统运行所需的时空成本；能分析和解释实验结果对应的物理意义，理解系统的使用对象、适用范围，综合得到合理有效的结论。课程目标3：指标点5.3：能对复杂计算机系统的运行进行测试和模拟，能分析系统、算法和工具的局限性。', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (43, '计算机系', NULL, 'XX120230', '计算机系统结构', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (44, '计算机系', NULL, 'XX127060', '计算机硬件课程设计', '', NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (45, '计算机系', NULL, 'XX120440', '算法设计与分析', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (46, '计算机系', NULL, 'XX127110', '应用软件开发课程设计', '', NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (47, '计算机系', NULL, 'XX127290', '毕业设计（论文）（含毕业实习）', '', NULL, NULL, NULL, NULL, NULL, 3, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (48, '计算机系', NULL, 'XX120620', 'JAVA编程基础', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (49, '计算机系', NULL, 'XX120200', '计算机图形学', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (50, '计算机系', NULL, 'XX120730', '计算机图像处理', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (51, '管理系', NULL, 'JY120280', '供应链管理', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (52, '英语系', NULL, 'WY110650', '物流英语', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (53, '计算机系', NULL, 'XX120760', '计算机科学导论', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (54, '英语系', NULL, '00100061', '大学英语（一）', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (55, '体育部', NULL, '00370007', '武术散打', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (56, '英语系', NULL, 'WY120721', '商务英语（一）', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (57, '计算机系', NULL, 'XX110290s', '面向对象程序设计实验', '', NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (58, '英语系', NULL, 'WY110680', '口语实践', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (59, '行政系', NULL, '00340028', '中国古典小说欣赏', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (60, '法学院', NULL, '00330011', '法律与社会', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (61, '英语系', NULL, '00100062', '大学英语（二）', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (62, '计算机系', NULL, 'XX110360', '软件工程', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (63, '法学院', NULL, '00330001', '海商法', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (64, '管理系', NULL, '00320006', '物流学概论', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (65, '法学院', NULL, '00330004', '海上货物运输法规', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (66, '英语系', NULL, 'WY120710', '中级口译', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (67, '教务处', NULL, '00370010', '大学生心理健康教育', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (68, '英语系', NULL, '00350011', '职业汉语', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (69, '行政系', NULL, 'WL410060', '概论', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (70, '英语系', NULL, 'WY110660', '口译实践', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (71, '计算机系', NULL, 'XX127010', '实用软件实践', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (72, '计算机系', NULL, 'XX127040', '程序设计课程设计', '', NULL, NULL, NULL, NULL, NULL, 2, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (74, '', NULL, 'QT110010', '物流信息系统', '', NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (75, '', NULL, 'JY120280', '供应链管理', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (76, '', NULL, 'JY391001', '国际航运概论', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (77, '', NULL, 'JY191001', '港口概论', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (78, '', NULL, 'QT892001', '美学通论', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (79, '', NULL, 'HH395003', '奇异的仿生学', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (80, '', NULL, 'YS193001', '大学美术', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (81, '', NULL, 'QT493001', '音乐名作鉴赏', '', NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (82, '计算机系', NULL, 'XX110820', '微机接口技术', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `courseinfo` VALUES (83, '计算机系', NULL, 'XX110820s', '微机接口技术实验', NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `experiment`  (
  ...
  `sClass` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sState` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `p1` double(20, 2) NULL DEFAULT NULL,
  `r1` double(20, 2) NULL DEFAULT NULL,
  `p2` double(20, 2) NULL DEFAULT NULL,
  `r2` double(20, 2) NULL DEFAULT NULL,
  `p3` double(20, 2) NULL DEFAULT NULL,
  `r3` double(20, 2) NULL DEFAULT NULL,
  `p4` double(20, 2) NULL DEFAULT NULL,
  `r4` double(20, 2) NULL DEFAULT NULL,
  `p5` double(20, 2) NULL DEFAULT NULL,
  `r5` double(20, 2) NULL DEFAULT NULL,
  `p6` double(20, 2) NULL DEFAULT NULL,
  `r6` double(20, 2) NULL DEFAULT NULL,
  `p7` double(20, 2) NULL DEFAULT NULL,
  `r7` double(20, 2) NULL DEFAULT NULL,
  `p8` double(20, 2) NULL DEFAULT NULL,
  `r8` double(20, 2) NULL DEFAULT NULL,
  `regular` double(20, 2) NULL DEFAULT NULL,
  `written` double(20, 2) NULL DEFAULT NULL,
  `overall` double(20, 2) NULL DEFAULT NULL,
  `exper_id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `gdesign`  (
  `sTime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cId` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `cNum` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sId` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `sName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `grade1_1` double(20, 2) NULL DEFAULT NULL,
  `grade1_2` double(20, 2) NULL DEFAULT NULL,
  `grade1_3` double(20, 2) NULL DEFAULT NULL,
  `grade1_4` double(20, 2) NULL DEFAULT NULL,
  `grade1_5` double(20, 2) NULL DEFAULT NULL,
  `grade1_6` double(20, 2) NULL DEFAULT NULL,
  `grade2_1` double(20, 2) NULL DEFAULT NULL,
  `grade2_2` double(20, 2) NULL DEFAULT NULL,
  `grade2_3` double(20, 2) NULL DEFAULT NULL,
  `grade2_4` double(20, 2) NULL DEFAULT NULL,
  `grade3_1` double(20, 2) NULL DEFAULT NULL,
  `grade3_2` double(20, 2) NULL DEFAULT NULL,
  `grade3_3` double(20, 2) NULL DEFAULT NULL,
  `overall` double(20, 2) NULL DEFAULT NULL,
  `gdesign_id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `procedure_standard`  (
  ...
  `standard` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `score_detail`  (
  `item_id` bigint NOT NULL COMMENT '每个评分小项编号',
  `stu_id` bigint NOT NULL COMMENT '学生学号',
  `value` float NULL DEFAULT 0 COMMENT '每个评分小项的实际分数',
  PRIMARY KEY (`item_id`, `stu_id`) USING BTREE,
  CONSTRAINT `fk_item_id` FOREIGN KEY (`item_id`) REFERENCES `course_item` (`item_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
