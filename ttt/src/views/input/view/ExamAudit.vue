...
export default {
  ...
  computed: {
      ...
      setTotal:function(){
        this.testContent.ContentDis.Total.push(this.calArray(this.testContent.ContentDis.Attendance));
        this.testContent.ContentDis.Total.push(this.calArray(this.testContent.ContentDis.CPerformance));
