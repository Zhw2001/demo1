      ...
      <el-table-column label="学年">
        <template slot-scope="scope">
          <el-input
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.stime }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="课程编号">
        <template slot-scope="scope">
          <el-input
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.cid }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="课程序号">
        <template slot-scope="scope">
          <el-input
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.cnum }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="学生编号">
        <template slot-scope="scope">
          <el-input
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.sid }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="学生姓名">
        <template slot-scope="scope">
          <el-input
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.sname }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="学生专业">
        <template slot-scope="scope">
          <el-input
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.sclass }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="学生状态">
        <template slot-scope="scope">
          <el-input
            size="small"
            v-if="scope.row.selected"
            v-model="scope.row.sstate"
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.sstate }}</span>
        </template>
      </el-table-column>

      <el-table-column label="选题">
        <template slot-scope="scope">
          <el-input
            size="small"
            v-if="scope.row.selected"
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.select }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="平时">
        <template slot-scope="scope">
          <el-input
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.begin }}</span>
        </template>
      </el-table-column>

      <el-table-column label="中期检查">
        <template slot-scope="scope">
          <el-input
            size="small"
            v-if="scope.row.selected"
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.medium }}</span>
        </template>
      </el-table-column>

      <el-table-column label="程序检查">
        <template slot-scope="scope">
          <el-input
            size="small"
            v-if="scope.row.selected"
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.program }}</span>
        </template>
      </el-table-column>

      <el-table-column label="答辩情况">
        <template slot-scope="scope">
          <el-input
            size="small"
            v-if="scope.row.selected"
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.answer }}</span>
        </template>
      </el-table-column>

      <el-table-column label="设计报告">
        <template slot-scope="scope">
          <el-input
            size="small"
            v-if="scope.row.selected"
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.report }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="总分">
        <template slot-scope="scope">
          <el-input
            ...
            placeholder="学年"
          ></el-input>
          <span v-if="!scope.row.selected">{{ scope.row.overall }}</span>
        </template>
      </el-table-column>
