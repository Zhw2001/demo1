  ...
  <div>
    <body>
      ...
      <form name="form1" style="position:fixed;">
        <div id="login-box" class="mya">
          <div class="text-center logintitle">
            <img src="@/assets/img/smulogo.svg" id="logo" /><span class="sfrz"
              >身份认证</span
            >
          </div>
      ...
      <footer
        ...
        class="py-4 d-flex justify-content-center cas-footer"
        width="100px"
        height="100px"
      >
        <div>
...
body {
  ...
  align-items: center;
  background: linear-gradient(45deg, rgb(245, 245, 247), rgb(242, 241, 245))
    fixed;
}
