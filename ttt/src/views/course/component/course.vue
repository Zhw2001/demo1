...
export default{
    ...
    methods:{
        ...
        loadCids(){
            ...
            for( let i of this.dataList.CourseData ){
                let temp = {}
                temp.label = i.cname
                temp.value = i.cid
        ...
        loadData(cid){//确定cid才能确定数据
            for( let i = 0; i < this.dataList.CourseData.length; i++ ){
                if(this.dataList.CourseData[i].cid == cid){
                    this.formData.data = this.dataList.CourseData[i].course
                    break
                }
            }
        ...
        loadSTime(){//确定数据才能确定stime
            ...
            console.log(this.formData.stimeList)
        },
