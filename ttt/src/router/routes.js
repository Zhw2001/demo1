...
const allDynamicRoutes = [
  { id: '1', name: 'ea', title: '内容合理性审核', icon: 'el-icon-s-check', key:'EA' },
  { id: '2', parent_id: '1', name: 'ea_input', title: '考试/考核信息', path: 'eaInput', component: '/examAudit/view/ExamAudit', key:'EA_Input' },
  ...
  { id: '6', parent_id: '5', name: 'ade_input', title: '达成度评价信息', path: 'cdInput', component: '/achieveDegreeEvalution/view/CourseDegree', key:'ADE_Input' },
